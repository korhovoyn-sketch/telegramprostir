...
async function generateExcel(
  ...
  const colLetter = (header: string): string => {
    ...
    // Було `String.fromCharCode(65 + i)` — валідне лише до 26 колонок, а їх
    // уже 24. Двадцять сьома дала б «[» замість «AA», тобто НЕВАЛІДНУ формулу
    // SUM у грошовому підсумку. Нижче 26 результат ідентичний попередньому.
    let s = ''
