...
44×44. Заміряний розрив — 22 контроли по 34-36px висоти (всі проходять по
ширині): `.hdr-back` 35, `.seg-b` / `.view-seg-b` / `.obj-act-btn` / `.notif-tab`
34, `.fr-seg-b` 36. Найризикованіший — `.obj-act-btn`: чотири суміжні цілі в
рядку картки, і розширювати їхню зону вгору не можна, бо там тіло картки
(відкриття обʼєкта) — тобто це не одна CSS-правка, а рішення про висоту рядків.
